...
public class RadarServiceApplication {
	...
	CommandLineRunner start(InfractionService infractionService, RadarRepository radarRepository){
		return args -> {
			...
			ma.enset.radarservice.entities.Radar radar1 = radarRepository.save(new ma.enset.radarservice.entities.Radar(null,4.5,6.8,100.0f));
			radarRepository.save(radar1);

			ma.enset.radarservice.entities.Radar radar2 = radarRepository.save(new ma.enset.radarservice.entities.Radar(null,4.5,6.8,100.0f));
			radarRepository.save(radar2);

			ma.enset.radarservice.entities.Radar radar3 = radarRepository.save(new ma.enset.radarservice.entities.Radar(null,4.5,6.8,100.0f));
